...
class Category
{
    ...
    public static function getCategories(
        ...
        // get from cache
        // Cache mode disabled by John
        if (!1 && $config['cache'] && (!defined('REALM') || (defined('REALM') && REALM != 'admin')) && !$from_db) {
    ...
    public static function getCategoryMultilingualPath($id, $lang)
    {
        ...
        // Custom changes by @Curtis [Flynax-Team] | Ticket ID: AWS-112867
        // if ($config['cache']) {
