...
<article class="item banner-item" id="banner_{$mBanner.ID}">{strip}
    ...
    <div class="nav">
        ...
        <div class="navigation">
            <ul>
                <li class="nav-icon">
                    <a class="edit" href="{pageUrl key='banners_edit_banner' vars="id=`$mBanner.ID`"}">
                ...
                {if $mBanner.Status != 'expired' && $mBanner.Status != 'incomplete'}
                    <li class="nav-icon">
                        <a class="renew"
                            title="{$lang.banners_renewPlan}"
                            href="{pageUrl key='banners_renew' vars="id=`$mBanner.ID`"}"
                        >
                ...
                <li class="nav-icon">
                    <a class="delete" id="delete_banner_{$mBanner.ID}" href="javascript://" title="{$lang.delete}">
                ...
                <li>
                    <div class="statuses">
                        {if $mBanner.Status == 'incomplete'}
                            <a class="{$mBanner.Status}"
                                href="{pageUrl key=$pageInfo.Key vars="incomplete=`$mBanner.ID`&step=`$mBanner.Last_step`"}"
                            >
                                {$lang[$mBanner.Status]}
                            </a>
                        {elseif $mBanner.Status == 'expired'}
                            <a title="{$lang.banners_renewPlan}"
                                class="{$mBanner.Status}"
                                href="{pageUrl key='banners_renew' vars="id=`$mBanner.ID`"}"
                            >
                                {$lang[$mBanner.Status]}
                            </a>
