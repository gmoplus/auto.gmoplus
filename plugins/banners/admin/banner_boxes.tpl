                    ...
                    <div id="parent_cats">
                        <div style="margin: 0 0 8px;">
                            <div class="tree">
                                ...
                                {foreach from=$sections item='section' name='banners_lTypes'}
                                    {if isListingTypesOnHomePage()}
                                        <label><input {if $sPost.box_after_category == $section.Key}checked="checked"{/if} class="lang_add" type="radio" name="box_after_category" value="{$section.Key}" /> {$section.name}</label>
                                    {else}
                                        <fieldset class="light">
        ...
        <tr class="box-type-def {if $sPost.box_type && $sPost.box_type == 'btc'}hide{/if}">
            ...
            <td class="field" id="pages_obj">
                <fieldset class="light">
                    ...
                    <div id="pages">
                        <div id="pages_cont" {if !empty($sPost.show_on_all) || $smarty.get.action == 'add'}style="display: none;"{/if}>
                        ...
                        <div class="grey_area" style="margin: 0 0 5px;">
                            <label><input id="show_on_all" {if $sPost.show_on_all || $smarty.get.action == 'add'}checked="checked"{/if} type="checkbox" name="show_on_all" value="true" /> {$lang.sticky}</label>
                            <span id="pages_nav" {if $sPost.show_on_all || $smarty.get.action == 'add'}class="hide"{/if}>
            ...
            <td class="field">
                <fieldset class="light">
                    ...
                    <div id="cats">
                        ...
                        <div id="cat_checkboxed" style="margin: 0 0 8px;{if $sPost.cat_sticky || $smarty.get.action == 'add'}display: none{/if}">
                            <div class="tree">
                                {foreach from=$sections item='section'}
                                    <fieldset class="light">
                                        ...
                                        <div id="section_{$section.ID}">
                                            {if !empty($section.Categories)}
                                                {include file='blocks/category_level_checkbox.tpl' categories=$section.Categories first=true}
                                            {else}
                                                <div style="padding: 0 0 8px 10px;">{$lang.no_items_in_sections}</div>
                                            {/if}
                                        </div>
                        ...
                        <div class="grey_area">
                            <label><input class="checkbox" {if $sPost.cat_sticky || $smarty.get.action == 'add'}checked="checked"{/if} type="checkbox" name="cat_sticky" value="true" /> {$lang.sticky}</label>
                            <span id="cats_nav" {if $sPost.cat_sticky || $smarty.get.action == 'add'}class="hide"{/if}>
...
<div id="delete_block" class="hide">
    {include file='blocks/m_block_start.tpl' block_caption=$lang.banners_deleteBannersBox}
    ...
    function delete_chooser(key, name) {
        rlPrompt(delete_confirm_phrase.replace('{box}', name), 'deleteBox', key);
    }
    {/literal}
    //]]>
    </script>
