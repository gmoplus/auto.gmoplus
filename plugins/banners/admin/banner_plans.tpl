        ...
        <td class="field">
            ...
            <fieldset class="light">
                ...
                <div id="boxes_tab_area" style="padding: 0 10px 10px 10px;">
                    ...
                    <tr>
                        <td>
                            ...
                            {foreach from=$boxes item='b_box' name='b_type'}
                                <td>
                                    <div style="margin: 0 20px 0 0;">
                                        <input {if $sPost.boxes && $b_box.Key|in_array:$sPost.boxes}checked="checked"{/if}
                                               style="margin-bottom: 0px;"
                                               type="checkbox"
                                               id="boxes_{$b_box.Key}"
                                               value="{$b_box.Key}"
                                               name="boxes[]"
                                        />
                                        <label for="boxes_{$b_box.Key}">{$b_box.name}</label>
                                    </div>
                                </td>
                    ...
                    <div class="grey_area" style="margin: 8px 0 0;">
                        <span onclick="$('#boxes_tab_area input').prop('checked', true);" class="green_10">{$lang.check_all}</span>
                        <span class="divider"> | </span>
                        <span onclick="$('#boxes_tab_area input').prop('checked', false);" class="green_10">{$lang.uncheck_all}</span>
                    </div>
                </div>
            </fieldset>
            {else}
        ...
        <td class="field">
            <fieldset class="light">
                ...
                <div id="banner_type_tab_area" style="padding: 0 10px 10px 10px;">
                    ...
                    <tr>
                        <td>
                            ...
                            <tr>
                                <td>
                                    <div style="margin: 0 20px 0 0;">
                                        <input {if $sPost.banner_type && 'image'|in_array:$sPost.banner_type}checked="checked"{/if}
                                               style="margin-bottom: 0px;"
                                               type="checkbox"
                                               id="banner_type_image"
                                               value="image"
                                               name="banner_type[]"
                                        />
                                        <label for="banner_type_image">{$lang.banners_bannerType_image}</label>
                                    </div>
                                </td>
                                <td>
                                    <div style="margin: 0 20px 0 0;">
                                        <input {if $sPost.banner_type && 'html'|in_array:$sPost.banner_type}checked="checked"{/if}
                                               style="margin-bottom: 0px;"
                                               type="checkbox"
                                               id="banner_type_html"
                                               value="html"
                                               name="banner_type[]"
                                        />
                                        <label for="banner_type_html">{$lang.banners_bannerType_html}</label>
                                    </div>
                                </td>
                            </tr>
                            </table>
                    ...
                    <div class="grey_area" style="margin: 8px 0 0;">
                        <span onclick="$('#banner_type_tab_area input').prop('checked', true);" class="green_10">{$lang.check_all}</span>
                        <span class="divider"> | </span>
                        <span onclick="$('#banner_type_tab_area input').prop('checked', false);" class="green_10">{$lang.uncheck_all}</span>
                    </div>
                </div>
            </fieldset>
        </td>
                ...
                <div id="countries_tab_area" style="padding: 0 10px 10px 10px;">
                    ...
                    <tr>
                        <td class="field">
                            ...
                            {elseif $sPost.$checkbox_field == '3' && $mf_locations}
                                {assign var=$checkbox_field|cat:'_mf' value='checked="checked"'}
                            {else}
                                {assign var=$checkbox_field|cat:'_yes' value='checked="checked"'}
                            {/if}
                            ...
                            <tr>
                                <td>
                                    <div class="grey_area">
                                        {if $mf_locations}
                                        <input {$banners_geo_mf} type="radio" id="{$checkbox_field}_mf" name="{$checkbox_field}" value="3" /> <label for="{$checkbox_field}_mf">{$lang.banners_mf_locations}</label>
                                        {/if}
                    ...
                    <tr id="select-countries" class="{if !$sPost || $sPost.banners_geo == 1 || $sPost.banners_geo == 3}hide{/if}">
                        <td class="field">
                            <div class="country-checkboxes">
                                {foreach from=$countries item='entry' name='c_name'}
                                    ...
                                    <div style="background-image: url('{$cflag}');" title="{$entry->Country_name}" class="box-checkboxes">
                                        <input {if $sPost.countries && $entry->Country_code|in_array:$sPost.countries}checked="checked"{/if}
                                               type="checkbox"
                                               id="country_{$entry->Country_code}"
                            ...
                            <div class="grey_area" style="margin: 8px 0 0;">
                                <span onclick="$('#countries_tab_area input').prop('checked', true);" class="green_10">{$lang.check_all}</span>
                                <span class="divider"> | </span>
                                <span onclick="$('#countries_tab_area input').prop('checked', false);" class="green_10">{$lang.uncheck_all}</span>
                            </div>
                        </td>
                    </tr>
                    </table>
                    ...
                    {if $mf_locations}
                    <div id="mf_regions" class="tree {if !$sPost.$checkbox_field || $sPost.$checkbox_field == 1}hide{/if}">
                        {include file=$smarty.const.RL_PLUGINS|cat:'banners/admin/mf_locations.tpl' first=true}
                    </div>

                    <script>
                    var mf_tree_selected = {if $sPost.mf_locations}{$sPost.mf_locations|@json_encode}{else}false{/if};
                    var mf_tree_parentPoints = {if $mfParentPoints}{$mfParentPoints|@json_encode}{else}false{/if};
                    var mf_loaderTree;
                    var mf_openTree;
                    var mf_levels = {$mf_levels};
                    {literal}

                    /**
                     * Get next level locations
                     *
                     * @since 2.7.1 - The second parameter (level) added
                     *
                     * @param  int parent - Parent level ID
                     * @param  int level  - Current level number
                     */
                    var mfGetChildren = function(parent, level) {
                        $.post(rlConfig.ajax_url, {
                            'item': 'bannersGetChildrenLocations',
                            'parent': parent
                        }, function(response) {
                            if (response.status === 'OK') {
                                var $parentDiv = $('#mf_tree_' + parent);
                                $parentDiv.append(response.html);

                                if (level + 1 == mf_levels) {
                                    $parentDiv.find('> ul img').addClass('no_child');
                                }

                                $parentDiv.find('ul:first').show();
                                $parentDiv.find('img:first').addClass('opened');
                                $parentDiv.find('span.tree_loader:first').remove();

                                mf_loaderTree();
                                mf_openTree(mf_tree_selected, mf_tree_parentPoints);
                    ...
                    /**
                     * Get number of the current element level | Recursive function
                     *
                     * @since 2.7.1
                     *
                     * @param  object $element - Element to count levels from
                     * @param  int    count    - Current level
                     * @return int             - Levels number
                     */
                    var countLevel = function($element, count){
                        var $ul = $element.parent().closest('ul');

                        if ($ul.length) {
                            if ($ul.hasClass('first')) {
                                return count;
                            } else {
                                return countLevel($ul, ++count);
                            }
                        }
                    ...
                    $(document).ready(function() {
                        mf_loaderTree = function() {
                            $('div.tree ul li>img:not(.no_child)').unbind('click').click(function() {
                                if ( $(this).hasClass('done') ) {
                                    var img = this;
                                    $(this).parent().find('ul:first').fadeToggle(function() {
                                        if ( $(this).is(':visible') ) {
                                            $(img).addClass('opened');
                                            $(img).closest('li').find('input').attr('disabled', false);
                                            $(img).closest('li').find('input:first').attr('disabled', true).hide();
                                        }
                                        else {
                                            $(img).removeClass('opened');
                                            $(img).closest('li').find('input').attr('disabled', true);
                                            $(img).closest('li').find('input:first').attr('disabled', false).show();
                                        }
                                    });
                                }
                                else {
                                    var mf_parent = $(this).closest('li').attr('id').split('mf_tree_')[1];
                                    mfGetChildren(mf_parent, countLevel($(this), 1));

                                    $(this).addClass('done').parent().find('span.tree_loader').fadeIn('fast');
                                    $(this).closest('li').find('input:first').attr('disabled', true).hide();
                                }
                            });
                        ...
                        mf_openTree = function(selected, points) {
                            if ( selected.length > 0 ) {
                                for ( var i = 0; i < selected.length; i++ ) {
                                    $('#mf_tree_'+ selected[i] +'>label>input').prop('checked', true);
                                }
                            }
                            if ( points.length > 0 ) {
                                $('#mf_tree_'+ points[0] +'>img:first').trigger('click');
                                points.splice(0, 1);
                            }
                        };
                        mf_loaderTree();
...
$(document).ready(function(){
    ...
    $('div#countries_tab_area>table input[type=radio]').click(function() {
        ...
        $('div#mf_regions').fadeOut('fast');

        if ( $(this).val() == 0 || $(this).val() == 2 ) {
            $('tr#select-countries').fadeIn('fast');
        }
        else if ( $(this).val() == 3 ) {
            $('div#mf_regions').fadeIn('fast');
        }
    });
...
<div id="delete_block" class="hide">
    {include file='blocks/m_block_start.tpl' block_caption=$lang.banners_deleteBannersPlan}
    ...
    function delete_chooser(key, name) {
        rlConfirm(delete_confirm_phrase.replace('{plan}', name), 'deletePlan', key);
    }
    {/literal}
    //]]>
    </script>
        ...
        columns: [
            {
                ...
                header: lang['banners_boxPosition'],
                dataIndex: 'Position',
                width: 6,
                editor: new Ext.form.NumberField({
                    allowBlank: false,
                ...
                renderer: function(data) {
                    ...
                    out += "<img class='remove' ext:qtip='"+ lang['ext_delete'] +"' src='"+ rlUrlHome +"img/blank.gif' onclick='rlConfirm( \""+ lang['ext_notice_delete'] +"\", \"prepareDeleting\", \""+ Array(data) +"\", \"section_load\" )' />";
                    out += "</center>";
